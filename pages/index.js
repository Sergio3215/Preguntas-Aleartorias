            ...
            <Card className='w-2/3 lg:left-72 md:left-40 top-unit-60 h-2/3 sm:left-36 lmb:left-28 mb:left-12'>
                <CardBody>
                    <div className='text-center font-bold lg:text-8xl sm:text-5xl lmb:text-4xl mb:text-2xl'>
                        ...
                        {/* <Divider /> */}
                        <Button className="bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 lg:w-unit-7xl md:w-unit-7xl sm:w-unit-7xl h-unit-3xl lg:text-5xl sm:text-5xl left-5 lmb:left-2 lmb:text-5xl  lmb:w-unit-7x mb:left-1 mb:text-2xl" onPress={async () => { extractJSON(); onOpen(); }}>Comenzar</Button>
                    </div>
                </CardBody>
            </Card>
